...
const { test, SYNTAX_CASES, getTSParsers } = require("./utils");
const rule = require("../src/no-private");
const { RuleTester } = require("eslint");

const ruleTester = new RuleTester();

ruleTester.run("no-private", rule, {
  valid: [
      ...
      invalid: [
        test(
          Object.assign(
            {
              code:
                "import { foo } from './ts-deprecated.ts'; console.log(foo())",
              errors: [
                {
                  type: "ImportSpecifier",
